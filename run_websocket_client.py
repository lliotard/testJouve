...
async def main():
    ...
    kwargs_websocket_a = {"hook": hook, "verbose": args.verbose, "host": "10.0.0.6"}
    kwargs_websocket_b = {"hook": hook, "verbose": args.verbose, "host": "10.0.0.7"}
    alice = websocket_client.WebsocketClientWorker(id="alice", port=8777, **kwargs_websocket_a)
    bob = websocket_client.WebsocketClientWorker(id="bob", port=8778, **kwargs_websocket_b)
